...
By default, `yt-summary` is local-first and privacy-friendly when used with Ollama, while still supporting paid cloud models via LiteLLM or Omniroute proxies.
